...
![다익스트라 최단 경로 알고리즘](/image/algorithm-thisiscote-07-1643232454877.png)
![다익스트라 최단 경로 알고리즘](/image/algorithm-thisiscote-07-1643232421218.png)

### 동작과정 살펴보기

![](/image/algorithm-thisiscote-07-1643232544473.png)
- 초기 상태
  - 그래프를 준비하고 출발노드를 설정한다. 
  - 거리가 짧은 노드인 1을 선택
  - 나머지는 무한으로 초기화

![](/image/algorithm-thisiscote-07-1643232668727.png)
...
![](/image/algorithm-thisiscote-07-1643232816495.png)
...
![](/image/algorithm-thisiscote-07-1643233022910.png)
...
![](/image/algorithm-thisiscote-07-1643233201316.png)
- 이제 가장 짧은 노드는 5이다. 
- 5에서는 3번과 6번을 갈 수 있다. 
  - 3번 : 4 > 1+1+1 = 갱신!
  - 6번 : 무한 > 1+1+2 = 갱신!
...
![](/image/algorithm-thisiscote-07-1643233308670.png)
- 남아있는 3번을 선택한다. 
- 3번에서는 2번과 6번을 갈 수 있는데 두 경우 모두 계산결과 이미 최단거리값을 가지고 있다. 따라서 갱신되지 않는다. 

![](/image/algorithm-thisiscote-07-1643233384701.png)
...
![](.//image/algorithm-thisiscote-07-1644052063468.png)
...
![](/image/algorithm-thisiscote-07-1643244959857.png)


## 플로이드 워셜 알고리즘 동작과정 살펴보기
- [자세히 설명보기](https://youtu.be/acqm9mM1P6o?list=PLRx0vPvlEmdAghTr5mXQxGpHjWqSz0dgC&t=2746) 

![](/image/algorithm-thisiscote-07-1643245004239.png)

![](/image/algorithm-thisiscote-07-1643245266749.png)
- 현재 1번 노드를 거쳐가는 경우를 고려하기에 1번행, 1번열과 자기 자신으로 향하는 케이스들은 모두 갱신대상에서 제외된다.

![](/image/algorithm-thisiscote-07-1643245314898.png)
