...
date: 2022-01-15T12:45:23.000Z
category: event
---

# sudo - CTO's Tech Talk 2022 컨퍼런스 1일차
...
* 검색으로 검색어 추천
* 상세에서 연관상품 추천 (대체제)
  * 번개톡 -> 구매로 바로 이어짐 ~~- 장바구니에서 연관상품 추천(보완제)~~
* 구매
...
추천 알고리즘 content-based filtering, 아이템의 속성 기반 추천
...
COVID 와 함께 마스크 관련 사기가 엄청 증가함 -> 사기건들에 대해서 패턴 분석을 함
...
* API 응답의 성공과 실패에 대한 표준 ![](../../.gitbook/assets/event-fc-sudo-20220115-1642234073261.png)
...
1. 코드자체의 중요성 만큼 코드가 동작하는 인프라 환경 역시 중요하다.
