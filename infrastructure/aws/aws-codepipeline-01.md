...
![출처 : https://docs.aws.amazon.com/ko_kr/codepipeline/latest/userguide/welcome-introducing.html](/.gitbook/assets/aws-pipeline-01-0.png)
...
파이프라인이 설정 완료되면, 소스코드를 어디서 가져올지 설정한다.
