...
* [java](trouble-shooting/java/README.md)
  * [java string.split(".") 오류](trouble-shooting/java/java-string.split-..md)
* [spring](trouble-shooting/spring/README.md)
  * [특정 매소드만 transaction 처리하기](trouble-shooting/spring/transactional.md)
...
* [📶 network](cs/network/README.md)
  ...
  * [네트워크 토폴로지와 병목현상](cs/network/undefined-1.md)
  * [네트워크 기초 3](cs/network/3.md)
  * [네트워크의 기초 2](cs/network/2.md)
  * [네트워크의 기초](cs/network/undefined-2.md)
* [🟪 design pattern](cs/design-pattern/README.md)
  * [static 을 자주 사용하게 되었을 때의 단점](cs/design-pattern/static.md)
  * [자바스크립트의 class와 static](cs/design-pattern/class-static.md)
  * [프로그래밍 컨텍스트](cs/design-pattern/undefined.md)
  * [의존성 주입 vs. 전략패턴](cs/design-pattern/vs..md)
  * [flux pattern](cs/design-pattern/flux-pattern.md)
  * [Spring MVC 패턴 적용 사례](cs/design-pattern/spring-mvc.md)
  * [MVC, MVP, MVVM pattern](cs/design-pattern/mvc-mvp-mvvm-pattern.md)
  * [프록시 패턴](cs/design-pattern/undefined-1.md)
  * [옵저버 패턴](cs/design-pattern/undefined-2.md)
  * [전략패턴](cs/design-pattern/undefined-3.md)
  * [의존성주입과 의존관계역전원칙](cs/design-pattern/undefined-4.md)
  * [이터레이션 패턴](cs/design-pattern/undefined-5.md)
  * [추상 팩토리 매소드 패턴](cs/design-pattern/undefined-6.md)
  * [팩토리 메소드 패턴](cs/design-pattern/undefined-7.md)
  * [싱글톤 패턴](cs/design-pattern/undefined-8.md)
  * [디자인 패턴, 라이브러리와 프레임워크의 차이](cs/design-pattern/undefined-9.md)
...
* [👾 알고리즘/자료구조 위키](datatype-and-algorithm/undefined/README.md)
  ...
  * [Math](datatype-and-algorithm/undefined/math/README.md)
    ...
    * [최대공약수, 최소공배수](datatype-and-algorithm/undefined/math/undefined-1/README.md)
      * [백준 2824 최대공약수, BigInteger](datatype-and-algorithm/undefined/math/undefined-1/2824-biginteger.md)
      * [백준 2609 최대공약수, 최소공배수](datatype-and-algorithm/undefined/math/undefined-1/2609.md)
    * [소수찾기](datatype-and-algorithm/undefined/math/undefined-2/README.md)
      * [백준 1978 소수찾기](datatype-and-algorithm/undefined/math/undefined-2/1978.md)
      * [백준4948 베르트랑 공준](datatype-and-algorithm/undefined/math/undefined-2/4948.md)
      * [백준 8393 합](datatype-and-algorithm/undefined/math/undefined-2/8393.md)
      * [백준 1929 소수구하기](datatype-and-algorithm/undefined/math/undefined-2/1929.md)
  * [Backtracking](datatype-and-algorithm/undefined/backtracking.md)
  * [Array and List](datatype-and-algorithm/undefined/array-and-list/README.md)
    * [표준 라이브러리](datatype-and-algorithm/undefined/array-and-list/undefined.md)
  * [Linked list](datatype-and-algorithm/undefined/linked-list.md)
  * [String](datatype-and-algorithm/undefined/string.md)
  * [Stack](datatype-and-algorithm/undefined/stack/README.md)
    * [백준 1874 스택수열](datatype-and-algorithm/undefined/stack/1874.md)
    * [백준 10828 스택 구현하기](datatype-and-algorithm/undefined/stack/10828.md)
  * [Queue](datatype-and-algorithm/undefined/queue/README.md)
    * [백준 10845 큐 구현하기](datatype-and-algorithm/undefined/queue/10845.md)
  * [Heap](datatype-and-algorithm/undefined/heap.md)
    * [백준 11298 절대값힙](datatype-and-algorithm/undefined/heap/11298.md)
  ...
  * [Recursion](datatype-and-algorithm/undefined/recursion-1.md)
    ...
    * [recursion 응용 - 미로찾기](datatype-and-algorithm/undefined/recursion-1/recursion.md)
    * [순환 알고리즘의 설계](<datatype-and-algorithm/undefined/recursion-1/undefined (1).md>)
    * [순환적으로 사고하기](datatype-and-algorithm/undefined/recursion-1/undefined.md)
    * [백준 17478 재귀함수가 뭔가요](datatype-and-algorithm/undefined/recursion-1/17478.md)
    * [백준 10870 피보나치수 5](datatype-and-algorithm/undefined/recursion-1/10870-5.md)
  * [Sort](datatype-and-algorithm/undefined/sort/README.md)
    * [java 에서의 정렬](datatype-and-algorithm/undefined/sort/java.md)
    * [radix sort](datatype-and-algorithm/undefined/sort/radix-sort.md)
    * [sorting in linear time](datatype-and-algorithm/undefined/sort/sorting-in-linear-time.md)
    * [comparison sort 에서 최상의 시간복잡도](datatype-and-algorithm/undefined/sort/comparison-sort.md)
    * [priority queue](datatype-and-algorithm/undefined/sort/priority-queue.md)
    * [heap sort](datatype-and-algorithm/undefined/sort/heap-sort.md)
    * [quick sort](datatype-and-algorithm/undefined/sort/quick-sort.md)
    * [merge sort](datatype-and-algorithm/undefined/sort/merge-sort.md)
  * [Dynamic Programming](datatype-and-algorithm/undefined/dynamic-programming/README.md)
    * [백준9251 LCS](datatype-and-algorithm/undefined/dynamic-programming/9251-lcs.md)
    * [백준 9461 파도반 수열](datatype-and-algorithm/undefined/dynamic-programming/9461.md)
    * [백준 1003 피보나치 함수](datatype-and-algorithm/undefined/dynamic-programming/1003.md)
    * [Knapsack problem](datatype-and-algorithm/undefined/dynamic-programming/knapsack-problem.md)
...
* [java](java-spring/java/README.md)
  * [ArrayList 초기화 방법들](java-spring/java/page-1.md)
  * [synchronized](java-spring/java/synchronized.md)
* [java 8](java-spring/java-8/README.md)
  * [Optional](java-spring/java-8/optional.md)
  * [interface의 default 메소드와 static 메소드](java-spring/java-8/interface-default-static.md)
  * [함수형 인터페이스](java-spring/java-8/undefined.md)
* [spring framework](java-spring/spring-framework/README.md)
  * [스프링이란](java-spring/spring-framework/undefined.md)
  * [오브젝트와 의존관계](java-spring/spring-framework/undefined-1.md)
  * [테스트](java-spring/spring-framework/undefined-2.md)
  * [템플릿](java-spring/spring-framework/undefined-3.md)
  * [예외](java-spring/spring-framework/undefined-4.md)
  * [서비스 추상화 1](java-spring/spring-framework/1.md)
  * [서비스 추상화 2](java-spring/spring-framework/2.md)
  * [AOP 1](java-spring/spring-framework/aop-1.md)
  * [AOP 2](java-spring/spring-framework/aop-2.md)
  * [스프링 핵심 기술의 응용](java-spring/spring-framework/undefined-5.md)
  * [스프링이란 무엇인가](java-spring/spring-framework/undefined-6.md)
  * [스프링 프로젝트 시작하기](java-spring/spring-framework/undefined-7.md)
* [querydsl](java-spring/querydsl/README.md)
  * [querydsl 을 쓰는 이유](java-spring/querydsl/querydsl-good-01.md)
  * [JPA querydsl에서 json array 로 된 컬럼에 조건 적용하기](java-spring/querydsl/querydsl-json-column.md)
  * [querydsl 에서 mysql order by field() 사용하기](java-spring/querydsl/querydsl-orderybyfield.md)
...
* [📅 review](writings/annual-review/README.md)
...
* [📚 bookcord](writings/bookcord/README.md)
  * [< 여행의 이유 > 내가 여행하는 이유](writings/bookcord/book-whyitravel.md)
  * [돈의 감각을 길러주는 경제 지식 첫걸음](writings/bookcord/page-5/README.md)
    * [금리](writings/bookcord/page-5/page-7.md)
    * [환율](writings/bookcord/page-5/undefined.md)
    * [주식](writings/bookcord/page-5/undefined-1.md)
    * [채권](writings/bookcord/page-5/undefined-2.md)
    * [부동산](writings/bookcord/page-5/undefined-3.md)
    * [연금](writings/bookcord/page-5/undefined-4.md)
    * [경제정책](writings/bookcord/page-5/undefined-5.md)
    * [규제](writings/bookcord/page-5/undefined-6.md)
    * [경제위기](writings/bookcord/page-5/undefined-7.md)
